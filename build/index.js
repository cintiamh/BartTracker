...
"use strict";
eval("\nvar __importDefault = (this && this.__importDefault) || function (mod) {\n    return (mod && mod.__esModule) ? mod : { \"default\": mod };\n};\nexports.__esModule = true;\n/**\n * Helper methods doing calls to Bart's API. Using axios since it supports promises.\n * Making it GraphQL friendly. (@cintiamh)\n */\nvar axios_1 = __importDefault(__webpack_require__(/*! axios */ \"axios\"));\n// Bart's official API key\nvar BART_API_KEY = 'MW9S-E7SL-26DU-VV8V';\nvar BART_API_MAIN_PATH = 'https://api.bart.gov/api/';\nfunction getStations() {\n    return axios_1[\"default\"].get(\"https://api.bart.gov/api/stn.aspx?cmd=stns&key=MW9S-E7SL-26DU-VV8V&json=y\").then(function (resp) {\n        return resp.data.root.stations.station;\n    });\n}\nexports.getStations = getStations;\nfunction getStationByAbbr(abbr) {\n    return axios_1[\"default\"].get(\"http://api.bart.gov/api/stn.aspx?cmd=stninfo&orig=\" + abbr + \"&key=MW9S-E7SL-26DU-VV8V&json=y\").then(function (resp) {\n        return resp.data.root.stations.station;\n    });\n}\nexports.getStationByAbbr = getStationByAbbr;\nfunction getRoutes() {\n    return axios_1[\"default\"].get('http://api.bart.gov/api/route.aspx?cmd=routes&key=MW9S-E7SL-26DU-VV8V&json=y')\n        .then(function (resp) {\n        return resp.data.root.routes.route;\n    });\n}\nexports.getRoutes = getRoutes;\nfunction getRouteByNum(num) {\n    return axios_1[\"default\"].get(\"http://api.bart.gov/api/route.aspx?cmd=routeinfo&route=\" + num + \"&key=MW9S-E7SL-26DU-VV8V&json=y\")\n        .then(function (resp) {\n        return resp.data.root.routes.route;\n    });\n}\nexports.getRouteByNum = getRouteByNum;\n\n\n//# sourceURL=webpack:///./api/fetches.ts?");
